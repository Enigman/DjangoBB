...
from djangobb_forum.forms import PersonalProfileForm, MessagingProfileForm, \
...
urlpatterns = [
    ...
    url('^topic/(?P<topic_id>\d+)/delete_posts/$', forum_views.delete_posts,
        name='delete_posts'),
    ...
    # Subscription
    url('^subscription/topic/(?P<topic_id>\d+)/delete/$', forum_views.delete_subscription,
        name='forum_delete_subscription'),
    url('^subscription/topic/(?P<topic_id>\d+)/add/$', forum_views.add_subscription,
        name='forum_add_subscription'),
...
if (forum_settings.LOFI_SUPPORT):
    urlpatterns += [
        ...
        url('^(?P<forum_id>\d+)/lofi/$', forum_views.show_forum, {'full': False},
            name='lofi_forum'),
        url('^topic/(?P<topic_id>\d+)/lofi/$', forum_views.show_topic, {'full': False},
            name='lofi_topic'),
    ]
...
if (forum_settings.ATTACHMENT_SUPPORT):
    urlpatterns += [
        url('^attachment/(?P<hash>\w+)/$', forum_views.show_attachment,
